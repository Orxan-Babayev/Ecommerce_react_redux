...
const Header = () => {
  ...
  const handleSearch = () => {
    ...
    navigate(`/shop`); // Navigate to the shop page with search query as URL parameter
    setQuery("");
  };
      ...
      <header className={headerstyles.head}>
        ...
        <nav className={headerstyles.nav}>
          ...
          <ul className={headerstyles.navbar}>
            ...
            <li>
              <Link to={"/shop"} className={headerstyles.navigate}>
                SHOP
              </Link>
            </li>
            <li>
          ...
          <ul className={headerstyles.icons}>
            <Link>
              ...
              <li>
                ...
                <GrPowerReset onClick={handleReset}></GrPowerReset> Reset button
            ...
            <Link>
              {" "}
              <li>
                <CiHeart onClick={handleWishlistIconClick} />{" "}
