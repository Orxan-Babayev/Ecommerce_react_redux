                            ...
                            <div className={styles.item}>
                                <Link>
                                    ...
                                    <div className={styles.card}>
                                        <h3 className={styles.title}>Match outfits with other significant</h3>
                        ...
                        <SwiperSlide  >
                            <div className={styles.item}>
                                <Link>
                                    ...
                                    <div className={styles.card}>
                                        <h3 className={styles.title}>Fresh work outfits for new year</h3>
                        ...
                        <SwiperSlide className={styles.item} >
                            <div className={styles.item}>
                                ...
                                <Link>
                                    ...
                                    <div className={styles.card}>
                                        <h3 className={styles.title}>Spotlights the new role models</h3>
